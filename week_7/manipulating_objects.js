...
// I had a hard time trying to create the carson object and then assigning a property to it with the value of cason.
// I was constantly trying to do it all in one line but it was not working. I decide it to creat the carson object first then in another 
// line I created the property name and the value carson. I guess it was not working before because I was not creating the carson object correctly.

// How difficult was it to add and delete properties outside of the object itself?
// It was extremely easy trying to delete the properties inside an object. I use the delete operator.

// What did you learn about manipulating objects in this challenge?
// I learned how to add properties and values into objects. I learned how to delete properties and create new objects.
// Finally I learned how to create objects within objects.
